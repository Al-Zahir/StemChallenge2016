Shader "Nature/Terrain/Standard" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Standard vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer fullforwardshadows alphatest:_CutoutModeHideAlpha2 addshadow
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			o.Alpha = 1 - transApplication;
			o.Albedo = mixedDiffuse.rgb / o.Alpha;
			
			if(o.Alpha > _CutoutModeHideAlpha)
				o.Alpha = 1;
